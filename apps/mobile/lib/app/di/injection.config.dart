...
import 'modules/feature_module.dart' as _i121;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i130.AppLogger>(
        () => appModule.logger(gh<_i650.AppConfig>()));
    gh.lazySingleton<_i646.SecureStorage>(
        () => storageModule.secureStorage(gh<_i650.AppConfig>()));
    gh.lazySingleton<_i646.KeyValueStorage>(
        () => storageModule.keyValueStorage(gh<_i650.AppConfig>()));
    gh.lazySingleton<_i361.Dio>(() => networkModule.dio(
          gh<_i650.AppConfig>(),
          gh<_i130.AppLogger>(),
          gh<_i107.TokenProvider>(),
        ));
    gh.lazySingleton<_i1024.SettingsBloc>(() => _i1024.SettingsBloc(
          gh<_i646.KeyValueStorage>(),
          gh<_i130.AppLogger>(),
        ));
    ...
    gh.lazySingleton<_i81.AppRouter>(
        () => appModule.router(gh<_i277.AuthBloc>()));
    gh.lazySingleton<_i894.ProfileRepository>(
        () => featureModule.profileRepository(
              gh<_i107.ApiClient>(),
              gh<_i650.AppConfig>(),
            ));
...
class _$FeatureModule extends _i121.FeatureModule {}
